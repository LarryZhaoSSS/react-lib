...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'r-parts-upload-list' }, fileList.map(function (item) {
        return (React.createElement("li", { className: 'r-parts-upload-list-item', key: item.uid },
            React.createElement("span", { className: "file-name file-name-" + item.status },
                React.createElement(Icon, { icon: 'file-audio', theme: 'secondary' }),
                item.name),
